...
- `twrp-home.png` — TWRP main screen (proof of unlocked bootloader)
- `magisk-installed.png` — Magisk app showing installed + `su -c id` = `context=u:r:magisk:s0`
- `kiss-home.png` — KISS launcher as home with the Simian app icons
- `godmode-ui.png` — GOD MODE menu
- `bt-nowplaying.png` — phone audio playing with now-playing metadata on the Echo screen
